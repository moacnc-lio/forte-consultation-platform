...
deploy_backend_local() {
    ...
    gcloud run deploy $BACKEND_SERVICE \
        ...
        --set-env-vars "APP_ENV=production,GCP_PROJECT=$PROJECT_ID,GCP_REGION=$REGION,DB_INSTANCE=forte-db,INSTANCE_CONNECTION_NAME=$PROJECT_ID:$REGION:forte-db,ALLOWED_ORIGINS=https://forte-web-hhlhhgenaq-du.a.run.app" \
